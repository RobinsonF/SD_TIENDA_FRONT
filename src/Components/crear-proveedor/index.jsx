...
const CrearProveedor = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch('http://localhost:8080/TiendaVirtualSB/proveedor/registrarProveedor', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="bg-white w-1/2 rounded-lg p-4 shadow-md">
      <label className="text-2xl text-black font-semibold">Crear proveedor</label>
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex justify-end">
          ...
          <button
            ...
            onClick={() => {
              context.setOpenModalCrearProveedor(false);
            }}
          >
            Cancelar
          </button>

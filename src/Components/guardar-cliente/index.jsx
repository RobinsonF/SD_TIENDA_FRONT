...
const ClienteForm = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch('http://localhost:8080/TiendaVirtualSB/cliente/registrarCliente', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="bg-white w-1/2 rounded-lg p-4 shadow-md">
      <label className="text-2xl text-black mb-4 font-semibold">Crear Nuevo Cliente</label>
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex justify-end">
          ...
          <button
            ...
            onClick={() => {
              context.setOpenModalSaveCliente(false);
            }}
          >
            Cancelar
          </button>
